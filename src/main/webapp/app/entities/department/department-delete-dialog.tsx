...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleDomainApp.department.delete.question">
        <Translate contentKey="sampleDomainApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
