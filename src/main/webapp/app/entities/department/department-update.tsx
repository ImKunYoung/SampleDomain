  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleDomainApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="sampleDomainApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleDomainApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('sampleDomainApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
