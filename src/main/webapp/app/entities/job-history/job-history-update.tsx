  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleDomainApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="sampleDomainApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleDomainApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('sampleDomainApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('sampleDomainApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('sampleDomainApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('sampleDomainApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('sampleDomainApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('sampleDomainApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
