...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleDomainApp.jobHistory.delete.question">
        <Translate contentKey="sampleDomainApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
