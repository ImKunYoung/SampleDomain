  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleDomainApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="sampleDomainApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleDomainApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('sampleDomainApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('sampleDomainApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('sampleDomainApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('sampleDomainApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
