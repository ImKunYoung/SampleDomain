    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobDetailsHeading">
          <Translate contentKey="sampleDomainApp.job.detail.title">Job</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="jobTitle">
              <Translate contentKey="sampleDomainApp.job.jobTitle">Job Title</Translate>
            </span>
          </dt>
          <dd>{jobEntity.jobTitle}</dd>
          <dt>
            <span id="minSalary">
              <Translate contentKey="sampleDomainApp.job.minSalary">Min Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.minSalary}</dd>
          <dt>
            <span id="maxSalary">
              <Translate contentKey="sampleDomainApp.job.maxSalary">Max Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.maxSalary}</dd>
          <dt>
            <Translate contentKey="sampleDomainApp.job.task">Task</Translate>
          </dt>
          <dd>
            {jobEntity.tasks
          ...
          <dt>
            <Translate contentKey="sampleDomainApp.job.employee">Employee</Translate>
          </dt>
