...
@RestController
@RequestMapping("/api/sample-domain-kafka")
public class SampleDomainKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SampleDomainKafkaResource.class);
    ...
    public SampleDomainKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
