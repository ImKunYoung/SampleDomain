...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('민곤').should('have.value', '민곤');

      cy.get(`[data-cy="lastName"]`).type('당').should('have.value', '당');

      cy.get(`[data-cy="email"]`).type('_41@naver.com').should('have.value', '_41@naver.com');

      cy.get(`[data-cy="phoneNumber"]`).type('Electronics Sleek back-end').should('have.value', 'Electronics Sleek back-end');

      cy.get(`[data-cy="hireDate"]`).type('2023-01-30T12:14').blur().should('have.value', '2023-01-30T12:14');
