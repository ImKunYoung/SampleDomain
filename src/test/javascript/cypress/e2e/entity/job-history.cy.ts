...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-01-31T03:19').blur().should('have.value', '2023-01-31T03:19');

      cy.get(`[data-cy="endDate"]`).type('2023-01-30T10:16').blur().should('have.value', '2023-01-30T10:16');
